...
Shader "Universal Render Pipeline/Custom/NoInterpolation"
{
    Properties
    {
...
#include "Assets/Amazing Assets/Curved World/Shaders/Core/CurvedWorldTransform.cginc"
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                // below with your own.
                BRDFData brdfData;
                InitializeBRDFData(surfaceData.albedo * input.vcolor, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.alpha, brdfData);
